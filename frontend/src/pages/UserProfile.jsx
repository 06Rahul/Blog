...
export const UserProfile = () => {
    ...
    const loadPostCount = async () => {
        try {
            const data = await import('../services/blogService').then((m) =>
                m.blogService.searchByAuthor(user.username, 0, 1)
            );
    ...
    return (
        ...
        >
            <div className="max-w-6xl mx-auto">
                ...
                >
                    {user.bannerImageUrl ? (
                        <div className="h-48 w-full bg-gray-200">
                            <img src={getImageUrl(user.bannerImageUrl)} className="w-full h-full object-cover" alt="Banner" />
                        </div>
                    ) : (
                ...
                >
                    <div className="px-6 md:px-12 py-6 border-b border-gray-100 dark:border-gray-700 flex gap-6 overflow-x-auto">
                        <button className="text-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent flex items-center gap-2 whitespace-nowrap">
                            Blogs
                        </button>
                    </div>
                    ...
                    <div className="p-6 md:p-12">
                        {user.contactInfo && (
                            <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <p className="text-gray-700 dark:text-gray-300 whitespace-pre-wrap">{user.contactInfo}</p>
                            </div>
                        )}
                        {user.interests && (
                            <div className="mb-8 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Interests</h3>
                                <p className="text-gray-700 dark:text-gray-300">{user.interests}</p>
                            </div>
                        )}
                        <h3 className="font-semibold text-xl text-gray-900 dark:text-white mb-6">Latest Posts</h3>
