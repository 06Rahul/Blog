...
export const CodeBlockHeader = ({ language, code }) => {
    ...
    const handleTryIt = () => {
        toast('Playground coming soon!', { icon: '🚧' });
    };
    ...
    return (
        <div className="flex justify-between items-center bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-1 select-none">
            ...
            <div className="flex items-center gap-3">
                <button
                    onClick={handleTryIt}
                    className="flex items-center gap-1.5 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors text-xs font-semibold"
                    title="Run Code (Coming Soon)"
                >
                    <div className="w-5 h-5 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                        <svg className="w-2.5 h-2.5 ml-0.5 opacity-50" fill="currentColor" viewBox="0 0 20 20"><path d="M6.3 2.841A1.5 1.5 0 004 4.11V15.89a1.5 1.5 0 002.3 1.269l9.344-5.89a1.5 1.5 0 000-2.538L6.3 2.84z" /></svg>
                    </div>
                </button>
