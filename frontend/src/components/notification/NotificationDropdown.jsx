    ...
    const handleNotificationClick = async (notification) => {
        try {
            ...
            if (notification.type === 'NEW_POST') {
                ...
                navigate(`/profile/${notification.sender.username}`); // Assuming sender has username
            }
        } catch (error) {
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            <p className="text-sm text-gray-800 dark:text-gray-200">
                                                ...
                                                {' '}{notification.message.replace(notification.sender.username, '').replace(notification.sender.firstName, '')} {/* Rudimentary cleanup if message includes name */}
                                            </p>
