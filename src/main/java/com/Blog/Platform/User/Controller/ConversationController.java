...
public class ConversationController {
    ...
    public ResponseEntity<Void> acceptConversation(@PathVariable UUID conversationId) {
        conversationService.acceptConversation(conversationId);
        return ResponseEntity.ok().build();
    }

    @PutMapping("/{conversationId}/reject")
    public ResponseEntity<Void> rejectConversation(@PathVariable UUID conversationId) {
        conversationService.rejectConversation(conversationId);
        return ResponseEntity.ok().build();
    }
}
