...
public class CommunityDTO {
    ...
    private com.Blog.Platform.Community.Model.CommunityMemberStatus myStatus; // The requesting user's status, null if not member
    ...
    public com.Blog.Platform.Community.Model.CommunityMemberStatus getMyStatus() {
        return myStatus;
    }

    public void setMyStatus(com.Blog.Platform.Community.Model.CommunityMemberStatus myStatus) {
